    ...
    */
    public int transformPixel(int []inPixel) {
        ...
        for(int i = 0; i < 9; i++)
        {
           ...
           {
               red += constrain(Color.red(inPixel[i]) );
               green += constrain(Color.green(inPixel[i]));
               blue += constrain(Color.blue(inPixel[i]));
           ...
           {
               red = red  -2 * constrain(Color.red(inPixel[i]) );
               green = green -2 * constrain(Color.green(inPixel[i]));
               blue = blue  -2 *constrain(Color.blue(inPixel[i]));
